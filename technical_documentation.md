...
In case there are several different hierarchical groups, the lowest hierarchical level will show the last ancestor of each hierarchy and they will not be grouped or collapsed (Figure 8, screenshots 1 and 2).

<p align="center">
    <img src="img/map_style_zoom_lowest.png" alt="map_style_zoom_lowest" title="Map style zoom lowest level" width="700"/><br/>
    <em>Figure 8 (screenshots 1 and 2). Map style zoom lowest level</em>
</p>
